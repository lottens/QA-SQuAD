...
from SQuAD import prepro, get_loader
...
parser.add_argument(
    '--glove_word_file',
    default=data_folder + 'glove.840B.300d/glove.840B.300d.txt',
...
parser.add_argument(
    '--word_emb_file',
    default=data_folder + 'word_emb.pkl',
    type=str, help='path of word embedding matrix file')
parser.add_argument(
    '--word_dictionary',
    default=data_folder + 'word_dict.pkl',
...
parser.add_argument(
    '--glove_char_file',
    default=data_folder + "glove.840B.300d/glove.840B.300d-char.txt",
...
parser.add_argument(
    '--char_emb_file',
    default=data_folder + 'char_emb.pkl',
    type=str, help='path of char embedding matrix file')
parser.add_argument(
    '--char_dictionary',
    default=data_folder + 'char_dict.pkl',
...
parser.add_argument(
    ...
    help='directory of saved model (default: save/)')
parser.add_argument(
    '--save_freq',
    default=1, type=int,
...
def main(args):
    ...
    trainer = Trainer(
        ...
        dev_file = args.dev_eval_file_json,
        optimizer=optimizer,
        scheduler=scheduler,
        epochs=args.epochs,
